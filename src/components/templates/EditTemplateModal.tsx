...
export const EditTemplateModal: React.FC<EditTemplateModalProps> = ({ isOpen, onClose, template, onSuccess }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Editar Template">
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="HARD">Hard (Incisivo)</option>
                        </select>
                    </div>
                </div>
                ...
                {/* Content */}
                <div>
                    <label className="block text-sm font-medium text-secondary mb-1">Conteúdo</label>
                    <div className="text-xs text-tertiary mb-2">Variáveis: {"{nome}"}, {"{valor}"}</div>
                    <textarea
                        required
                        rows={6}
